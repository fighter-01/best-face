...
from best_face_modules.configs.global_config import crop_width_margin, crop_height_margin
...
class TrackInfo:
    def __init__(self, id, bbox:np.ndarray, landmarks=None, quality=0, age=1,location=0):
        self.id = id
        self.location = 0
        self.bbox = bbox
        self.age = age
